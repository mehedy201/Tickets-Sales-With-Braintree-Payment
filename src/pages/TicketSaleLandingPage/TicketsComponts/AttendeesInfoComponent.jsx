...
// ✅ Full Working Code for AttendeesInfoComponent.jsx with Multiple Ticket Types
...
const TicketAttendeeBlock = ({ type, attendeeIndex }) => {
  ...
  return (
    <div className="border border-gray-300 rounded-lg p-4 mb-6">
      ...
      <div className="mt-4">
        <label className="block text-sm font-medium text-gray-700 mb-1">Do you require a visa letter of invitation?/Avez-vous besoin d'une lettre d'invitation pour un visa? <span className="text-red-500">*</span></label>
        <select {...register(`attendees.${attendeeIndex}.requireVisa`, { required: "Required" })} className="w-full border border-gray-300 rounded-md px-3 py-1.5 text-sm">
          <option value="NO">No/Non</option>
          <option value="YES">Yes/Oui</option>
        </select>
      </div>
      ...
      {visaWatch === "YES" && (
        <div className="grid grid-cols-1 gap-y-3 mt-4">
          ...
          <div>
            ...
            <input {...register(`attendees.${attendeeIndex}.countryOfPassport`, { required: "Required" })} className="w-full border border-gray-300 rounded-md px-3 py-1.5 text-sm" />
          </div>
        </div>
      )}
