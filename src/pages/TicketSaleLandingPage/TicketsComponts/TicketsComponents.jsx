    ...
    return (
        <div>
            ...
            <div className='sm:flex justify-between pb-5 border-b-1 border-gray-300'>
                <div>
                    <h2 className='text-[22px] font-bold pb-1'>Low and Middle Income Countries</h2>
            ...
            <div className='sm:flex justify-between py-5 border-b-1 border-gray-300'>
                <div>
                    <h2 className='text-[22px] font-bold pb-1'>Full Conference Registration</h2>
            ...
            <div className='sm:flex justify-between py-5 border-b-1 border-gray-300'>
                <div>
                    <h2 className='text-[22px] font-bold pb-1'>Corporate Attendees</h2>
